...
- `schemas/` - JSON schemas for manifests, permissions, UI, data, and versions.
- `examples/` - example manifests for GitHub-backed host-rendered modules.
- `registry/modules.json` - bundled registry seed.
